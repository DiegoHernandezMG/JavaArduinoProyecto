...
import javaarduinoproyecto.Usuario;
...
public class inicioSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText(" inicie sesión para poder comprar componentes");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (!"".equals(correo) || !"".equals(pass)) {
            ...
            if (l.getCorreo()!= null && l.getPassword() != null) {
                user = UserDao.consultarUsuarioId(correo);
                CompraComponentes objCompra = new CompraComponentes();
                objCompra.show();
                this.dispose();
            }else{
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        // TODO add your handling code here:
        crearCuenta objCuenta = new crearCuenta();
        objCuenta.show();
        this.dispose();
